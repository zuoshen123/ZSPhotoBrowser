...
{
   ZSGestureScrollView *_scrollview;
}
...
@implementation ZSGestureScrollView

- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer {
    if ([otherGestureRecognizer isKindOfClass:[UIPanGestureRecognizer class]] && [otherGestureRecognizer.view isKindOfClass:NSClassFromString(@"XLPhotoBrowser")]) {
...
{
    if (!_scrollview) {
        _scrollview = [[ZSGestureScrollView alloc] init];
...
- (void)setShowHighQualityImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder
{
    ...
    // TODO 失败点击重新下载功能
    [weakSelf.photoImageView yy_setImageWithURL:url placeholder:placeholder options:YYWebImageOptionHandleCookies progress:^(NSInteger receivedSize, NSInteger expectedSize) {
